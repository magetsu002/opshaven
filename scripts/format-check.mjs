...
const roots = ["src", "tests", "scripts", "docs", "integration", "examples", "packaging", "security", ".github"];
const rootFiles = ["README.md", "RELEASE_NOTES.md", "package.json", "package-lock.json", "tsconfig.json", "tsconfig.build.json", "tsconfig.readonly.json"];
const files = [];
...
else console.log(`format: ${new Set(files).size} files checked`);
